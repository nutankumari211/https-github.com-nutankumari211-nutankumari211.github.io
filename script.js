//The code is a JavaScript program that fetches meal data from an API 
//and displays it on a web page. It also allows users to mark certain meals as favorites, which are then stored in local storage.


// it makes a favourites meal array if its not exist in browser's local storage
if (localStorage.getItem("favouritesList") == null) {
    localStorage.setItem("favouritesList", JSON.stringify([]));
}

// it fetches meals from api and return it
//fetchMealsFromApi is a function that takes two arguments, a URL and a value to search for, and fetches data from the API at the specified URL.
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            ...
                            <button id="main${element.idMeal}" class="btn btn-primary" onclick="addRemoveToFavList(${element.idMeal})" style="border-radius:50%"><i class="fa-solid fa-heart"></i></button>
                        </div>
                    </div>
                </div>
                `;
